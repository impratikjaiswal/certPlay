...
-----END CERTIFICATE-----""",
            ...
            #
            Data(
                remarks='Default Input Format',
                input_data='amenitypj.in',
            ),
            #
            Data(
                remarks='cloudflare; Accessible',
                input_data=r'cloudflare.com',
                input_format=Formats.URL,
            ),
            #
            Data(
                remarks='cloudflare; https; www; Forbidden; url_pre_access=False',
            ...
            #
            Data(
                remarks='cloudflare; www; Forbidden; url_pre_access=False',
                input_data='www.cloudflare.com',
                input_format=Formats.URL,
                url_pre_access=False,
            ),
        ]
        ...
        data_pool_negative = [
            ...
            #
            Data(
                remarks='Inaccessible IP',
                input_data='1.2.3.4',
                input_format=Formats.URL,
            ),
            #
            Data(
                remarks='Inaccessible Web Site',
                input_data='https://amenitypj.com',
                input_format=Formats.URL,
            ),
            #
            Data(
                remarks='Invalid Time Out Integer',
                input_data='amenitypj.in',
                input_format=Formats.URL,
                url_time_out=50,
            ),
            #
            Data(
                remarks='Invalid Time Out String',
                input_data='amenitypj.in',
                input_format=Formats.URL,
                url_time_out='5',
            ),
            #
            Data(
                remarks='cloudflare; https; www; Forbidden',
                input_data=r'https://www.cloudflare.com',
                input_format=Formats.URL,
            ),
            #
            Data(
                remarks='cloudflare; https; www; Forbidden; Sub Pages',
                input_data=r'https://www.cloudflare.com/learning/ssl/transport-layer-security-tls/',
                input_format=Formats.URL,
            ),
            #
            Data(
                remarks='Url; Sub Pages; WikiPedia; time out error',
                input_data='https://en.wikipedia.org/wiki/Main_Page',
                input_format=Formats.URL,
            ),
        ]
