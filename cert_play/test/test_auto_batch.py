...
from cert_play import PACKAGE_NAME, MODULE_NAME
from cert_play.main.certplay import print_configurations
from cert_play.test.test_data import TestData


class TestAutoBatch:
    white_listed_tcs = None

    PROJECT_PATH = r'D:\Other\Github_Self\certPlay'

    get_file_path_mapping_relative = {
        PhKeys.VAR_EXECUTION_MODE: r'cert_play\main\certplay.py',
        PhKeys.VAR_ERROR_HANDLING_MODE: r'cert_play\main\certplay.py',
        PhKeys.VAR_TOP_FOLDER_PATH: r'cert_play\main\helper\folders.py',
    }
